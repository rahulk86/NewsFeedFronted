...
const StartReplyOnReply = ({setCommetData,reply,replies,profileData}) => {
  ...
  const handlePostEvent = async () => {
    ...
    replyData.replyId = reply.id;
     try{
      const response = await ReplyAuth.createNewReplyForReply(axiosPrivate,replyData);
     }
     catch(err){
...
`
export default StartReplyOnReply;
